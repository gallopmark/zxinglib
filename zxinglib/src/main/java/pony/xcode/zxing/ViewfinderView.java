...
public final class ViewfinderView extends View {
    ...
    public void setFrameRatio(@FloatRange(from = 0.0, to = 1.0) float frameRatio) {
    ...
    private void drawGridScanner(Canvas canvas, Rect frame) {
        ...
        //遍历绘制网格横线
        for (int i = 0; i <= height / wUnit; i++) {
            canvas.drawLine(frame.left, scannerStart - i * wUnit, frame.right, scannerStart - i * wUnit, paint);
        }
