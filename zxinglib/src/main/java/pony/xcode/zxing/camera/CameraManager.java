package pony.xcode.zxing.camera;
...
import pony.xcode.zxing.camera.open.OpenCamera;
import pony.xcode.zxing.camera.open.OpenCameraInterface;
...
//    private static final int MAX_FRAME_HEIGHT = 675; // = 5/8 * 1080
     ...
     */
    public synchronized void openDriver(@Nullable SurfaceHolder holder) throws IOException {
